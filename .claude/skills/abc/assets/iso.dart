...
// Alignment / LinearGradient 는 dart:ui 가 아니라 painting 에 있다.
// flutter/material.dart 를 통째로 끌어오면 Flame 의 vector_math 와 이름이
// 충돌하므로(mix, Colors 등) 필요한 것만 show 한다.
...
class Facing {
  ...
  /// 디버그 표시용 방향 이름.
  String get label => const ['S', 'SE', 'E', 'NE', 'N', 'NW', 'W', 'SW'][octant];
...
///
/// saveLayer 0회, 블러 0회. 실루엣 + 림만으로도 형태가 읽히므로 군중
/// 100명을 감당한다. 자세한 예산은 references/performance.md 참조.
